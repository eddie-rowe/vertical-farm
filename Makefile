...
## Show categorized help for all Makefile commands
help:
	@echo ""
	@echo "\033[1m=== Vertical Farm Makefile Commands ===\033[0m"
	@echo ""
	@echo "\033[1;33m🚀 QUICK START\033[0m"
	@echo "  \033[36mup\033[0m              Start all services (migrated to /up slash command)"
	@echo "  \033[36mdown\033[0m            Stop all services"
	@echo "  \033[36mlogs\033[0m            View logs for all services"
	@echo "  \033[36msetup\033[0m           Install all dependencies (backend & frontend)"
	@echo ""
	@echo "\033[1;33m🔧 DEVELOPMENT\033[0m"
	@echo "  \033[36mrun-backend\033[0m     Run FastAPI backend (dev mode)"
	@echo "  \033[36mrun-frontend\033[0m    Run Next.js frontend (dev mode)"
	@echo "  \033[36mbuild-frontend\033[0m  Build frontend for production"
	@echo ""
	@echo "\033[1;33m🧪 TESTING\033[0m"
	@echo "  \033[36mtest-all\033[0m        Run all tests (mirrors CI/CD pipeline)"
	@echo "  \033[36mtest-backend\033[0m    Run backend tests with pytest"
	@echo "  \033[36mtest-frontend\033[0m   Run frontend unit tests"
	@echo "  \033[36mtest-e2e\033[0m        Run Playwright E2E tests"
	@echo "  \033[36mtest-lint\033[0m       Run all linting checks"
	@echo ""
	@echo "\033[1;33m🛡️ SECURITY\033[0m"
	@echo "  \033[36mtest-security\033[0m   Run all security checks"
	@echo "  \033[36msecurity\033[0m        Run comprehensive security audit"
	@echo "  \033[36msetup-security\033[0m  Install security scanning tools"
	@echo ""
	@echo "\033[1;33m🗄️ DATABASE\033[0m"
	@echo "  \033[36mdb-studio\033[0m       Open Supabase Studio"
	@echo "  \033[36mdb-status\033[0m       Show database and migration status"
	@echo "  \033[36mdb-reset\033[0m        Reset database (destroys data!)"
	@echo "  \033[36mdb-diff\033[0m         Create migration from local changes"
	@echo ""
	@echo "\033[1;33m🐳 DOCKER\033[0m"
	@echo "  \033[36mup-docker\033[0m       Build and start Docker services"
	@echo "  \033[36mdown-docker\033[0m     Stop Docker services"
	@echo "  \033[36mclean-docker\033[0m    Clean Docker artifacts (volumes, orphans)"
	@echo ""
	@echo "\033[1;33m🌐 ENVIRONMENT\033[0m"
	@echo "  \033[36menv-check\033[0m       Show current environment status"
	@echo "  \033[36menv-templates\033[0m   Create environment template files"
	@echo ""
	@echo "\033[1;33m📝 CONTEXT\033[0m"
	@echo "  \033[36mcontext\033[0m         Update context from git state"
	@echo "  \033[36mcontext-show\033[0m    Show current context"
	@echo ""
	@echo "Run \033[36mmake <target>\033[0m to execute a command."
	@echo "For Claude Code slash commands: /up, /test, /plan, /dev, /validate, /deploy"
	@echo ""
