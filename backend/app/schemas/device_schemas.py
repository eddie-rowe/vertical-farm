...
class SetColorAction(BaseModel):
    ...
    rgb_color: List[int] = Field(..., min_length=3, max_length=3, description="RGB color values [R, G, B]")
...
DeviceAction = Union[
    TurnOnAction, TurnOffAction, ToggleAction, 
    SetBrightnessAction, SetColorAction, SetSpeedAction
]
