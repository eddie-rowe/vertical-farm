...
async def schedule_irrigation_cycle(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule irrigation: {str(e)}")
...
async def schedule_light_cycle(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule lighting: {str(e)}")

@router.post("/monitoring/schedule", response_model=TaskResponse)
async def schedule_sensor_monitoring(
    request: SensorMonitoringRequest,
    current_user: dict = Depends(get_current_user)
):
...
async def schedule_harvest_check(
    ...
    try:
        ...
        return TaskResponse(
            task_id=task_id,
            message="Harvest check scheduled"
        )
        
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to schedule harvest check: {str(e)}")
...
async def trigger_automation_rule(
    ...
    try:
        ...
        return TaskResponse(
            task_id=task_id,
            message="Automation rule evaluation triggered"
        )
        
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to trigger automation rule: {str(e)}")

@router.post("/alerts/schedule", response_model=TaskResponse)
async def schedule_maintenance_alert(
    request: MaintenanceAlertRequest,
    current_user: dict = Depends(get_current_user)
):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule alert: {str(e)}")
...
async def schedule_climate_control(
    ...
    try:
        ...
        return TaskResponse(
            task_id=task_id,
            message="Climate control adjustment scheduled"
        )
        
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to schedule climate control: {str(e)}")
...
async def schedule_all_farm_tasks(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule farm tasks: {str(e)}")
...
async def process_sensor_reading(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to process sensor reading: {str(e)}")
...
async def handle_sensor_threshold_alert(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to handle sensor threshold: {str(e)}")
...
async def test_irrigation_system(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to test irrigation: {str(e)}")
...
async def test_lighting_system(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to test lighting: {str(e)}")
