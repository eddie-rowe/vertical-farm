...
async def schedule_device_discovery(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule discovery: {str(e)}")
...
async def schedule_bulk_control(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule bulk control: {str(e)}")
...
async def schedule_morning_routine(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule morning routine: {str(e)}")


@router.post("/home-assistant/harvest-mode")
async def schedule_harvest_mode(
    current_user: dict = Depends(get_current_user)
):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule harvest mode: {str(e)}")
...
async def schedule_maintenance_mode(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to schedule maintenance mode: {str(e)}") 