...
describe('GrowRecipeCard', () => {
  ...
  it('calls onEdit when edit button is clicked', () => {
    ...
    const editButton = editButtons.find(button => button.querySelector('[data-testid="edit-icon"]'));
  ...
  it('calls onDelete when delete button is clicked', () => {
    ...
    const deleteButton = deleteButtons.find(button => button.querySelector('[data-testid="delete-icon"]'));
