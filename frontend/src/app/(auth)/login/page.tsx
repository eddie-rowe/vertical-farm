    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-100 via-blue-100 to-purple-100 dark:from-gray-800 dark:via-gray-900 dark:to-black">
      <Card className="w-full max-w-md shadow-2xl animate-pop glass">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold tracking-tight text-green-900 dark:text-green-100">Welcome Back!</CardTitle>
          <CardDescription className="text-gray-600 dark:text-gray-400">Sign in to access your Vertical Farm dashboard.</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="text-center text-sm text-gray-600 dark:text-gray-400">
          <p>
            Don&apos;t have an account? <Link href="/signup" className="font-medium text-green-700 hover:text-green-600 dark:text-green-400 dark:hover:text-green-300">Sign Up</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
