        ...
        <TabsContent value="germination" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitor germination progress across all tents and track seedling
                development
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mb-4">
                  This section will contain all germination management
                  functionality previously located in the standalone germination
                  management page.
                </p>
        ...
        <TabsContent value="transplant" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track seedlings ready for transplantation and manage the
                transition to growing areas
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mb-4">
                  This section will contain transplant management functionality
                  for tracking seedlings ready for transplantation.
                </p>
                <p className="text-sm text-gray-400">
                  Functionality will be implemented in the next phase.
                </p>
