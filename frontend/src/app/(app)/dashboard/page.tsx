                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                      ${strategicData.sales.currentWeeklyRevenue}
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      This Week
                    </div>
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                      ${strategicData.sales.fourWeekAverage}
                    </div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      4-Week Avg
                    </div>
                  ...
                  (event, eventIndex) => (
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        {event.daysAway} days away • {event.laborRequired}h
                        labor
                      </div>
...
export default function StrategicDashboardPage() {
  ...
  if (!user) {
    return (
      <div className="text-content">Please log in to access the dashboard.</div>
    );
  }
