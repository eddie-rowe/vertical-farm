...
export const mockGrowRecipeFixtures: GrowRecipe[] = [
  {
    ...
    lighting: {
      ...
      spectrum: { red: 30, blue: 20, white: 50 },
    },
  ...
  },
  {
    ...
    lighting: {
      ...
      spectrum: { red: 40, blue: 30, white: 30 },
    },
  ...
  },
  {
    ...
    lighting: {
      intensity: { percentage: 80 },
      spectrum: { red: 60, blue: 20, white: 20 },
    },
  ...
  },
  {
    ...
    lighting: {
      intensity: { percentage: 60 },
      spectrum: { red: 20, blue: 50, white: 30 },
    },
    fridge_storage_temp: 1,
    difficulty: 'Medium' as GrowDifficulty,
    custom_parameters: {
  ...
  },
  {
    ...
    water_frequency: 'every_4_hours',
    lighting: {
      intensity: { percentage: 40 },
      spectrum: { red: 10, blue: 20, white: 70 },
    },
