...
export function RealtimeProvider({ children }: { children: React.ReactNode }) {
  ...
  const [callbacks, setCallbacks] = useState<Map<string, ((event: RealtimeEvent) => void)[]>>(new Map())
  ...
  const handleHomeAssistantConfigUpdate = useCallback((event: RealtimeEvent) => {
