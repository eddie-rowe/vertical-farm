...
const mockEmployees: Employee[] = [
  {
    ...
    certifications: [
      {
        id: "1",
        name: "Certified Agriculture Manager",
        issuedBy: "AgTech Institute",
    ...
    trainingProgress: [
      {
        id: "1",
        courseName: "Advanced Hydroponic Systems",
        progress: 75,
  ...
  },
  {
    ...
    certifications: [
      {
        id: "3",
        name: "Hydroponic Specialist",
        issuedBy: "Hydro Institute",
    ...
    trainingProgress: [
      {
        id: "3",
        courseName: "IoT Sensor Integration",
        progress: 30,
      ...
      {
        id: "4",
        courseName: "Advanced Plant Nutrition",
        progress: 60,
  ...
  },
  {
    ...
    certifications: [
      ...
      {
        id: "6",
        name: "Harvest Quality Expert",
        issuedBy: "Farm Institute",
    ...
    trainingProgress: [
      ...
      {
        id: "6",
        courseName: "Packaging Innovation",
        progress: 20,
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {skillCategories.slice(1).map((category) => {
            ...
            const avgLevel =
              categorySkills.length > 0
                ...
                : 0;
            const certifiedCount = categorySkills.filter(
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          {mockEmployees
            .flatMap((emp) => emp.trainingProgress)
            .slice(0, 5)
            .map((training) => (
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {
                          employee.certifications.filter(
                            (c) => c.status === "active",
                          ).length
                        }
                      </span>
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span>Training:</span>
                      <span className="font-medium">
                        {employee.trainingProgress.length} active
                      </span>
                    </div>
                  </div>
