...
export const HeroMetrics = () => {
  const getTrendColor = (trend: 'up' | 'down' | 'stable') => {
    switch (trend) {
      ...
      case 'stable': return 'text-content-secondary';
          ...
          <CardContent className="p-0">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-sm font-medium text-content-secondary">{metric.title}</h3>
                  <p className="text-2xl font-bold text-content">{metric.value}</p>
                </div>
              </div>
            </div>
