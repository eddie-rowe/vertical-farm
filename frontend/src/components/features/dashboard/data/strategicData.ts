...
export const strategicData: StrategicData = {
  costs: {
    ...
    suggestions: [
      {
        action: "Switch to single-operator harvest process for basil",
        savings: 0.14,
        urgency: "medium",
      },
      {
        action: "Reduce overwatering in Grow Room 2",
        savings: 0.08,
        urgency: "high",
      },
      {
        action: "Reuse 20% of trays (sanitized) instead of new",
        savings: 0.12,
        urgency: "low",
      },
    ],
    alerts: [
      {
        message: "Utilities cost increased 12% vs prior month",
        type: "warning",
      },
    ],
  },
  sales: {
    ...
    suggestions: [
      {
        action: "Reconnect with 3 dormant customers",
        impact: "+$180/week",
        urgency: "high",
      },
      {
        action: "Offer seasonal microgreen blends",
        impact: "+$40 avg order",
        urgency: "medium",
      },
      {
        action: "Add standing order option for high-frequency customers",
        impact: "+15% retention",
        urgency: "low",
      },
    ],
  ...
  todaysTasks: {
    ...
    tasks: [
      {
        name: "Germinate sunflower trays",
        hours: 2,
        priority: "high",
        assigned: "John",
        status: "pending",
    ...
    suggestions: [
      {
        action: "Assign 1 person to clean/transfer simultaneously",
        impact: "Save 0.5 hours",
      },
      {
        action: "Ensure trays prepped before 11 AM",
        impact: "Prevent bottlenecks",
      },
    ],
  },
  upcomingEvents: [
  ...
  strategicNotes: [
    ...
    },
    {
      ...
      investigation:
        "consider cross-training team to reduce specialization bottlenecks",
      priority: "high",
