...
export const germinationAreaConfig: AreaConfiguration = {
  ...
  description: 'Specialized configuration for germination tents with seed tracking, transplant readiness, and compact layout',
...
export function getGerminationAreaConfig(preset: string = 'standard'): AreaConfiguration {
