...
export function FarmAreaTest({
  ...
  const rows =
    areaType === "grow_area" ? mockGrowingAreaRows : mockGerminationRows;
    ...
    <div className="space-y-6 p-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Testing the configurable farm area architecture with{" "}
            {configuration.name}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {configuration.overlays.length} configured
              </p>
            </div>
            <div>
              <span className="font-medium">Modals:</span>
              <p className="text-muted-foreground">
                {configuration.modals.length} available
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Double-click racks/shelves, right-click for context menu, or use
            keyboard navigation
          </CardDescription>
        </CardHeader>
        <CardContent>
    ...
    <div className="container mx-auto py-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mb-4">
          Testing the new configurable farm area architecture with different
          area types and presets
        </p>
        ...
        <div className="flex gap-2">
          ...
          <Button
            variant={
              activeAreaType === "germination_tent" ? "default" : "outline"
            }
