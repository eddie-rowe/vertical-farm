...
function farmAreaReducer(
  state: FarmAreaState,
  action: FarmAreaAction,
): FarmAreaState {
  switch (action.type) {
    case "SELECT_ROW":
      return {
    ...
    case "SELECT_ELEMENT":
      return {
        ...
        selectedRow:
          action.payload?.type === "row"
            ? (action.payload.data as Row)
            : state.selectedRow,
        selectedRack:
          action.payload?.type === "rack"
            ? (action.payload.data as Rack)
            : state.selectedRack,
        selectedShelf:
          action.payload?.type === "shelf"
            ? (action.payload.data as Shelf)
            : state.selectedShelf,
      };
    ...
    case "RESET_STATE":
      return {
        ...
        visibleOverlays: state.visibleOverlays.filter(
          (id) =>
