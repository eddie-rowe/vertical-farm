...
const SAMPLE_RECIPES: Recipe[] = [
  ...
  {
    id: '3',
    name: 'Quick Microgreens',
    description: 'Fast-turnaround microgreens for continuous production',
    ...
    stages: [
      {
        ...
        temperature: 20,
        humidity: 90,
        description: 'Dark germination period'
      },
      {
        id: '2',
        name: 'Green-up',
        ...
        temperature: 18,
        humidity: 75,
        description: 'Light exposure for greening'
      }
    ],
    nutrients: [
      { day: 1, nutrientType: 'Water Only', concentration: 0, ph: 6.0, ec: 0.2 },
      { day: 3, nutrientType: 'Light Feed', concentration: 0.4, ph: 6.0, ec: 0.8 }
    ]
  }
]

export const RecipeManagementPage: React.FC = () => {
    ...
    <div className="p-6 max-w-7xl mx-auto">
        ...
        <Card>
          <CardContent className="pt-4">
            <FarmSearchAndFilter
              ...
              searchPlaceholder="Search recipes by name, crop type, or description..."
      ...
      {filteredRecipes.length === 0 && (
        <div className="text-center py-16">
          ...
          {(hasSearch || hasActiveFilters) ? (
            <Button onClick={() => { clearSearch(); clearAllFilters(); }} variant="outline" className="gap-2 mr-2">
              Clear all filters
            </Button>
          ) : null}
          <Button onClick={() => setIsCreateModalOpen(true)} className="gap-2">
