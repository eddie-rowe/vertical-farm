  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent
        ...
        aria-describedby="entity-form-description"
      >
        <div id="entity-form-description" className="sr-only">
          Form to edit {entityType} properties including name and configuration
          settings.
        </div>
        <DialogHeader>
          <DialogTitle asChild>
            <div
              className={`flex items-center gap-3 p-2 rounded ${entityStyles[currentEntityType]}`}
            >
              <span
                className={`inline-flex items-center justify-center w-8 h-8 rounded-full ${iconBg[currentEntityType]} text-white`}
              >
          ...
          <div className="flex flex-col gap-3 py-4">
            {entityId && (
              <div>
                ...
                <div className="text-sm font-mono bg-gray-100 dark:bg-gray-800 rounded px-2 py-1">
                  {entityId}
                </div>
              </div>
            )}
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("width" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("depth" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("position_x" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("position_y" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("length" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("position_in_row" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("height" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
                ...
                <div>
                  <label
                    ...
                    className="text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                    Max Shelves (Optional)
                  </label>
                  <input
                    id="max_shelves"
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("max_shelves" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("position_in_rack" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    type="number"
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    {...register("max_weight" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                  />
            ...
            {currentEntityType === "fan" && (
              <>
                <div>
                  ...
                  <select
                    id="parent_type_fan"
                    {...register("parent_type" as Path<TFormValues>)}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  >
                ...
                <div>
                  ...
                  <input
                    id="parent_id_fan"
                    {...register("parent_id" as Path<TFormValues>)}
                    readOnly
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  />
                </div>
                <div>
                  ...
                  <input
                    id="model_number_fan"
                    {...register("model_number" as Path<TFormValues>)}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                ...
                <div>
                  ...
                  <input
                    id="size_cm_fan"
                    type="number"
                    {...register("size_cm" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                ...
                <div>
                  <label
                    htmlFor="airflow_cfm_fan"
                    className="text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                    Airflow (CFM) (Optional)
                  </label>
                  <input
                    id="airflow_cfm_fan"
                    type="number"
                    {...register("airflow_cfm" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                ...
                <div>
                  ...
                  <input
                    id="power_watts_fan"
                    type="number"
                    {...register("power_watts" as Path<TFormValues>, {
                      valueAsNumber: true,
                    })}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                ...
                <div>
                  <label className="text-xs font-semibold mt-2 text-gray-600 dark:text-gray-400">
                    Position (Optional)
                  </label>
                </div>
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    <label htmlFor="position_x_fan" className="text-xs">
                      X
                    </label>
                    <input
                      id="position_x_fan"
                      ...
                      className="mt-1 w-full p-1 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    />
                    {renderError("position_x" as Path<TFormValues>)}
                  </div>
                  <div>
                    <label htmlFor="position_y_fan" className="text-xs">
                      Y
                    </label>
                    <input
                      id="position_y_fan"
                  ...
                  <div>
                    <label htmlFor="position_z_fan" className="text-xs">
                      Z
                    </label>
                    <input
                      id="position_z_fan"
                      type="number"
                      {...register("position_z" as Path<TFormValues>, {
                        valueAsNumber: true,
                      })}
                      className="mt-1 w-full p-1 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    />
            ...
            {currentEntityType === "sensorDevice" && (
              <>
                <div>
                  <label
                    htmlFor="parent_type_sensor"
                    className="text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                    Parent Type
                  </label>
                  <select
                    id="parent_type_sensor"
                    {...register("parent_type" as Path<TFormValues>)}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  >
                ...
                <div>
                  <label
                    htmlFor="model_number_sensor"
                    className="text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                    Model Number (Optional)
                  </label>
                  <input
                    id="model_number_sensor"
                    {...register("model_number" as Path<TFormValues>)}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                  {renderError("model_number" as Path<TFormValues>)}
                ...
                <div>
                  <label
                    htmlFor="sensor_type_sensor"
                    className="text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                    Sensor Type
                  </label>
                  <select
                    id="sensor_type_sensor"
                    {...register("sensor_type" as Path<TFormValues>)}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  >
                    <option value="">Select Type</option>
                ...
                <div>
                  <label
                    htmlFor="measurement_unit_sensor"
                    className="text-sm font-medium text-gray-700 dark:text-gray-200"
                  >
                    Measurement Unit (Optional)
                  </label>
                  <input
                    id="measurement_unit_sensor"
                    {...register("measurement_unit" as Path<TFormValues>)}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label
                      htmlFor="data_range_min_sensor"
                      className="text-sm font-medium text-gray-700 dark:text-gray-200"
                    >
                      Data Range Min (Optional)
                    </label>
                    <input
                      id="data_range_min_sensor"
                      type="number"
                      {...register("data_range_min" as Path<TFormValues>, {
                        valueAsNumber: true,
                      })}
                      className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    />
                  ...
                  <div>
                    <label
                      htmlFor="data_range_max_sensor"
                      className="text-sm font-medium text-gray-700 dark:text-gray-200"
                    >
                      Data Range Max (Optional)
                    </label>
                    <input
                      id="data_range_max_sensor"
                      type="number"
                      {...register("data_range_max" as Path<TFormValues>, {
                        valueAsNumber: true,
                      })}
                      className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    />
                ...
                <div>
                  ...
                  <input
                    id="accuracy_sensor"
                    {...register("accuracy" as Path<TFormValues>)}
                    className="mt-1 w-full p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    <label htmlFor="position_x_sensor" className="text-xs">
                      X
                    </label>
                    <input
                      id="position_x_sensor"
                      type="number"
                      {...register("position_x" as Path<TFormValues>, {
                        valueAsNumber: true,
                      })}
                  ...
                  <div>
                    <label htmlFor="position_y_sensor" className="text-xs">
                      Y
                    </label>
                    <input
                      id="position_y_sensor"
                      type="number"
                      {...register("position_y" as Path<TFormValues>, {
                        valueAsNumber: true,
                      })}
                  ...
                  <div>
                    <label htmlFor="position_z_sensor" className="text-xs">
                      Z
                    </label>
                    <input
                      id="position_z_sensor"
                      type="number"
                      {...register("position_z" as Path<TFormValues>, {
                        valueAsNumber: true,
                      })}
