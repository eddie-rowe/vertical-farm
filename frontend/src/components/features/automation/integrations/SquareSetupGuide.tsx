...
export default function SquareSetupGuide({
  onComplete,
}: SquareSetupGuideProps) {
  const setupSteps = [
    {
      id: 1,
      title: "Create Square Developer Account",
      description:
        "Sign up for a Square Developer account to access API credentials",
    ...
    },
    {
      ...
      description:
        "Set up a new application in your Square Developer dashboard",
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Follow these steps to connect your Square account for payment
            processing and sales management
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              <strong>Important:</strong> Start with Sandbox credentials for
              testing. Switch to Production credentials only when you're ready
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your Square application will need these permissions to function
            properly
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Understanding the difference between Sandbox and Production
            environments
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardContent>
          <div className="space-y-4">
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <li>
                  • Verify your Application ID and Access Token are correct
                </li>
                <li>
                  • Ensure you're using the right environment (Sandbox vs
                  Production)
                </li>
                <li>
                  • Check that your Square application has the required
                  permissions
                </li>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <li>
                  • Ensure your Square account has at least one location set up
                </li>
                <li>
                  • Verify your application has MERCHANT_PROFILE_READ permission
                </li>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                <li>
                  • Review your application's permission settings in Square
                  Developer
                </li>
                <li>
                  • Regenerate your access token if permissions were recently
                  changed
                </li>
                <li>
                  • Contact Square support if you need additional permissions
                </li>
              </ul>
            </div>
          </div>
