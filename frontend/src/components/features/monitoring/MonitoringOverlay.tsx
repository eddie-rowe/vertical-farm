        ...
        <div className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={cn(
                        "text-2xl font-bold",
                        getHealthScoreColor(healthScore.environmental),
                      )}
                    >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={cn(
                        "text-2xl font-bold",
                        getHealthScoreColor(healthScore.growth),
                      )}
                    >
                      {healthScore.growth}%
                    </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p
                      className={cn(
                        "text-2xl font-bold",
                        getHealthScoreColor(healthScore.alerts),
                      )}
                    >
                      {healthScore.alerts}%
                    </p>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Live sensor data from your farm • Last updated:{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div
                  className={cn(
                    ...
                    getStatusColor(monitoringData.temperature.status),
                  )}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold">
                          {monitoringData.temperature.value.toFixed(1)}
                          {monitoringData.temperature.unit}
                        </p>
                      </div>
                    </div>
                ...
                <div
                  className={cn(
                    "p-4 rounded-lg border",
                    getStatusColor(monitoringData.humidity.status),
                  )}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold">
                          {monitoringData.humidity.value.toFixed(0)}
                          {monitoringData.humidity.unit}
                        </p>
                      </div>
                    </div>
                ...
                <div
                  className={cn(
                    "p-4 rounded-lg border",
                    getStatusColor(monitoringData.lightIntensity.status),
                  )}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold">
                          {monitoringData.lightIntensity.value.toFixed(0)}{" "}
                          {monitoringData.lightIntensity.unit}
                        </p>
                      </div>
                    </div>
                ...
                <div
                  className={cn(
                    "p-4 rounded-lg border",
                    getStatusColor(monitoringData.ph.status),
                  )}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold">
                          {monitoringData.ph.value.toFixed(1)}{" "}
                          {monitoringData.ph.unit}
                        </p>
                      </div>
                    </div>
                ...
                <div
                  className={cn(
                    "p-4 rounded-lg border",
                    getStatusColor(monitoringData.ec.status),
                  )}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold">
                          {monitoringData.ec.value.toFixed(1)}{" "}
                          {monitoringData.ec.unit}
                        </p>
                      </div>
                    </div>
