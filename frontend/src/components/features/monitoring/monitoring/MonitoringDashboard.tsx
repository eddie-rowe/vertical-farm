...
export const MonitoringDashboard: React.FC<MonitoringDashboardProps> = ({
  ...
  const getMetricIcon = (type: string) => {
    switch (type) {
      ...
      case 'ph': return <TestTube className="w-4 h-4" />;
              ...
              {metrics.slice(0, 4).map((metric) => (
                <div 
                  ...
                  className={cn(
                    ...
                    selectedMetricType === metric.type ? "bg-blue-50 dark:bg-blue-900/20 border-blue-300" : "bg-gray-50/50 dark:bg-gray-800/50"
                  )}
                  onClick={() => setSelectedMetricType(selectedMetricType === metric.type ? null : metric.type)}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1">
                  ...
                  <div className="mt-1">
                    <span className={cn("text-sm font-semibold", getMetricColor(metric.status))}>
            ...
            <>
              ...
              <div className="space-y-2">
                ...
                {metrics
                  ...
                  .map(metric => (
                    <div key={metric.id} className="p-2 bg-gray-50 dark:bg-gray-800 rounded-md">
                      ...
                      {metric.target && (
                        <div className="flex justify-between items-center mt-1">
                          ...
                          <span className="text-sm">{metric.target}{metric.unit}</span>
                        </div>
                      )}
                      {metric.range && (
                        <div className="flex justify-between items-center mt-1">
                ...
                <div className="space-y-1">
                  {criticalAlerts > 0 && (
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <Badge variant="outline" className="text-red-600 border-red-400 animate-pulse">
                        {criticalAlerts}
                      </Badge>
                    </div>
                  )}
