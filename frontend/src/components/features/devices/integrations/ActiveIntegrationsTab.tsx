...
const getStatusBadge = (status: ActiveIntegration['status']) => {
  switch (status) {
    ...
    default:
      return <Badge className="bg-farm-muted text-control-tertiary border-control-tertiary">Disconnected</Badge>;
  }
};
      ...
      <CardContent>
        ...
        <div className="mt-6 pt-6 border-t border-farm-border">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h3 className="text-control-label font-medium">Integration Actions</h3>
