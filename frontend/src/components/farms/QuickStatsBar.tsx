...
export default function QuickStatsBar({ stats, selectedFarm }: QuickStatsBarProps) {
  ...
  const activeGrowingAreas = stats.totalRows > 0 ? Math.min(stats.totalRows, Math.ceil(stats.totalShelves / 3)) : 0;
  
  // Mock alert count - in real app this would come from actual alert system
  const alertCount = stats.healthScore < 80 ? Math.floor((100 - stats.healthScore) / 10) : 0;
      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className={`flex items-center space-x-3 px-4 py-2 rounded-lg ${healthStatus.bgColor}`}>
