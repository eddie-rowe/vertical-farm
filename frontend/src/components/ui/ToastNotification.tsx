...
export const useToastHelpers = () => {
  ...
  const showDeviceAlert = useCallback((deviceName: string, alertType: 'connected' | 'disconnected' | 'battery_low' | 'sensor_error') => {
    const alerts = {
      connected: {
  ...
  const showEnvironmentalAlert = useCallback((location: string, metric: string, value: string, severity: 'warning' | 'critical') => {
