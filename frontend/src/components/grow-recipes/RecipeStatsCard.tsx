...
export function TotalRecipesCard({ count, trend }: { count: number; trend?: { value: number; isPositive: boolean } }) {
  return (
    <RecipeStatsCard
      title="Total Recipes"
      value={count}
...
export function AvgSuccessRateCard({ rate, trend }: { rate: number; trend?: { value: number; isPositive: boolean } }) {
  return (
    <RecipeStatsCard
...
export function AvgGrowTimeCard({ days, trend }: { days: number; trend?: { value: number; isPositive: boolean } }) {
  return (
    <RecipeStatsCard
      title="Avg Grow Time"
      value={`${days}d`}
