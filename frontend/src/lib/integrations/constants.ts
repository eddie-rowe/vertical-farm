...
export const INTEGRATION_MESSAGES = {
  business: "Connect Square or Stripe to automatically track revenue, customer payments, and sales trends from your farm sales.",
  devices: "Connect Home Assistant to control lights, pumps, fans, and sensors throughout your vertical farm.",
  ai: "Connect OpenAI or Anthropic to enable AI-powered crop analysis, yield predictions, and automated growth recommendations.",
  environmental: "Connect weather and sensor APIs to automatically track environmental conditions and optimize growing parameters.",
  inventory: "Connect supplier APIs to automate seed ordering, track inventory levels, and manage supply chain logistics."
};
