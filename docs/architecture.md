...
### **For All Developers**
1. Read [CLAUDE.md](/CLAUDE.md) for coding standards and service layer patterns
2. Understand [Database Schema](./reference/database-schema.md)
3. Review [API Endpoints](./reference/api/endpoints.md)
...
1. **Set up your development environment** - See [Quickstart Guide](./quickstart.md)
2. **Explore the codebase** - Follow the Project Structure section above
3. **Start contributing** - Check [Development Guide](./development/README.md)

## 📚 Further Reading

- **API Documentation** - [API Reference](./reference/api/README.md)
- **Database Schema** - [Database Design](./reference/database-schema.md)
- **Deployment Guide** - [Deployment Documentation](./operations/deployment.md)
